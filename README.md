...
* `notebooks/`: Jupyter notebooks containing the end-to-end experiments.
    ...
    * `02_Benchmark_*.ipynb`: Training and evaluation of supervised baselines (XGBoost, LSTM).
* `data/`: Placeholder for datasets (M4, M5, Traffic, ETTh1).
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/YOUR_USERNAME/zero-shot-vs-traditional-forecasting.git](https://github.com/YOUR_USERNAME/zero-shot-vs-traditional-forecasting.git)